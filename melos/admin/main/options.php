...
//			array(
//				'title'        => esc_html__( 'Need help?', 'melos' ),
//				'priority'     => 1,
//				'button_text'  => __( 'Hire a Developer', 'melos' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'price_discount'  => esc_html__( 'Upgrade Now (10% off)', 'melos' ),
				'price_normal'	  => esc_html__( 'Use coupon at checkout for 10% off.', 'melos' ),
				'coupon'	      => esc_html__( 'thinkup10', 'melos' ),
